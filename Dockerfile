...
# copy the requirements file (to current workdir)
...
# copy all required data files at once (into the data folder)
...
# Copy all required python scripts at once  (to current workdir)
COPY app.py \
...
# run the streamlit app (over port 8000)
